...
valgrind --leak-check=full --log-file=valgrind_log/test_xmly_audio_effects.log ./tests/test_xmly_audio_effects ../data/pcm_mono_44kHz_0035.pcm test_xmly_audio_effects.pcm
