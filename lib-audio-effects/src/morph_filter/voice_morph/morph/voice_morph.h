...
class VoiceMorph {
   public:
     ...
     *				0  - succeed
     **************************************************************************/
    int VoiceMorph_Create(char *file_name);
     ...
     *setting parameters.
     **************************************************************************/
    int VoiceMorph_SetConfig(float pitch_coeff);
     ...
     *				0  - succeed
     **************************************************************************/
    int VoiceMorph_Process(void *raw, short in_size, char *morph_out,
                           int * morph_out_size, bool robot);
